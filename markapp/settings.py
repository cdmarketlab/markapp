"""
------------------------------------------------------------------------------------------------------------------
Archivo de Settings de Marketlab-app, diseñado para evaluar, analizar y hacer test del mercado
Autor: José Luis Angeles Tapia
Empresa: MarketLab
Fecha: 17-Marzo-2023
------------------------------------------------------------------------------------------------------------------
"""
...
SECRET_KEY = 'django-insecure-1bp2b_2@f)7%_*z2k!igjxyl^z5i4sh3nvbyf7qj0w6!$=okr%'
...
DATABASES = {
        'default': {
            ...
            'NAME': 'u757732185_laboratorio',
            'USER': 'u757732185_cientificom1',
            'PASSWORD': 'Tewkix22@',
